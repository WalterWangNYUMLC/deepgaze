...
def main():
    ...
    my_cascade = haarCascade("/home/walter/Documents/others_git/deepgaze/etc/xml/haarcascade_frontalface_alt.xml", "/home/walter/Documents/etc/xml/haarcascade_profileface.xml")
    my_detector = faceLandmarkDetection('/home/walter/Documents/others_git/deepgaze/etc/shape_predictor_68_face_landmarks.dat')
