...
def main():
    ...
    my_cascade = haarCascade("/home/walter/Documents/others_git/deepgaze/etc/xml/haarcascade_frontalface_alt.xml", "/home/walter/Documents/others_git/deepgaze/etc/xml/haarcascade_profileface.xml")
    #TODO If missing, example file can be retrieved from http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
    my_detector = faceLandmarkDetection(os.path.join(filepath,'/home/walter/Documents/others_git/deepgaze/etc/shape_predictor_68_face_landmarks.dat'))
